	...
	_box2Start.on("click",function(){
		...
		setTimeout(function(){
			var pai1=setInterval(function(){
					var top=createRandom(1 ,0 ,500);
					var left=createRandom(1 ,-200 ,180);
					// console.log(_pai.eq(0).offset().left);
					// console.log(left[0])
		...
		function tPai1(){
			num1++;
			tPai(_pai.eq(7),430,0,40);
			tPai(_pai.eq(6),340,-30,30);
			tPai(_pai.eq(5),211,-56,20);
			tPai(_pai.eq(4),85,-65,7);
			tPai(_pai.eq(3),-40,-65,-7);
			tPai(_pai.eq(2),-175,-56,-20);
			tPai(_pai.eq(1),-299,-30,-30);
			tPai(_pai.eq(0),-402,0,-40);
			if (num1>=3) {
				console.log(111)
				setTimeout(function(){
				_box2_31.show();
